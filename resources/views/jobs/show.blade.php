<x-layout>
    ...
    <div><button form="delete-form" class="bg-red-500 hover:bg-red-800 px-4 py-2 rounded-md text-white font-semibold">Delete</button></div>
    <div class="flex justify-end"><x-button href="/jobs/{{ $job->id }}/edit">Edit Job</x-button></div></div>
